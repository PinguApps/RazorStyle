...
- Current plan: Done; both unresolved review comments have local fixes, regression coverage, and GitHub replies. RS0002 nested output expectation corrected.
...
- Key paths: src/PinguApps.RazorStyle.Core/Rules/AttributeOrderRule.cs, src/PinguApps.RazorStyle.Core/Rules/ChildContentLineRule.cs, tests/PinguApps.RazorStyle.Tests/Features/RazorStyleRules.feature
